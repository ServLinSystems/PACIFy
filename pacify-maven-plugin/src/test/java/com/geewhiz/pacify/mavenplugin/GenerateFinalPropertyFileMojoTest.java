...
import com.geewhiz.pacify.mavenplugin.mojo.CreatePropertyFileMojo;
...
public class GenerateFinalPropertyFileMojoTest extends AbstractMojoTestCase {
    ...
    public void doesNotWorkGeneratePropertyFile() throws Exception {
        CreatePropertyFileMojo mavenMojo = (CreatePropertyFileMojo) lookupMojo("generateFinalPropertyFile",
