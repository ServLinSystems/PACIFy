...
import com.geewhiz.pacify.mavenplugin.mojo.GenerateFinalPropertyFileMojo;
...
public class GenerateFinalPropertyFileMojoTest extends AbstractMojoTestCase {
    ...
    public void doesNotWorkGeneratePropertyFile() throws Exception {
        GenerateFinalPropertyFileMojo mavenMojo = (GenerateFinalPropertyFileMojo) lookupMojo("generateFinalPropertyFile",
